...
class DoctorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create doctor" do
    assert_difference("Doctor.count") do
      post doctors_url, params: { doctor: { first_name: @doctor.first_name, last_name: @doctor.last_name } }
    end
  ...
  test "should update doctor" do
    patch doctor_url(@doctor), params: { doctor: { first_name: @doctor.first_name, last_name: @doctor.last_name } }
